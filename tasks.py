...
class CopaDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        ...
        # train_examples = load_from_disk("/disk0/uni_group/jsr/MeZO-main/data/copa")["train"]
        # valid_examples = load_from_disk("/disk0/uni_group/jsr/MeZO-main/data/copa")["validation"]
...
class BoolQDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        ...
        # d = load_from_disk("/disk0/uni_group/jsr/MeZO-latest/AUZO-simplest/data/boolq")
        train_set = d["train"]
...
class SQuADDataset(Dataset):
    ...
    def load_dataset(self):
        ...
        # dataset = load_from_disk("/disk0/uni_group/jsr/MeZO-latest/AUZO-simplest/data/squad")
