MODEL=${MODEL:-/new_disk/uni_group/jsr_temp/pre-trained-llms/opt-13b}
MODEL_NAME=(${MODEL//\// })
...
python run.py \
    ...
    --load_best_model_at_end --evaluation_strategy steps --save_strategy steps --save_total_limit 10 \
